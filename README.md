...
* Uses [v13.0 of the current Full Emoji List](https://unicode.org/emoji/charts-13.0/full-emoji-list.html).
...
* big_regex.pkl is a pickled compiled regular expression. It's just 3299 regular expressions piped together in order of decreasing length. This is important to make sure that you can count multi-codepoint sequences like '💁🏽\u200d♂️' and so on.
